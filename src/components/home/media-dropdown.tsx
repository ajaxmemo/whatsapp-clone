...
import { ImageIcon, Plus, PlusIcon, Video } from "lucide-react";
...
import { sendImage } from '../../../convex/messages';
...
const MediaDropdown = () => {
    ...
    const generateUploadUrl = useMutation(api.coversations.generateUploadUrl);
    ...
    const handleSendImage = async () => {
		...
		try {
			...
			await sendImage({
				coversation: selectedConversation!._id,
				imgId: storageId,
				sender: me!._id,
			});
